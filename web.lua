...
local function drawCenteredText(y, text, fg, bg, offsetX) text = tostring(text or ""); Buffer.write(math.floor((Config.SCREEN_W - unicode.len(text)) / 2) + 1 + (offsetX or 0), y, text, fg or Colors.text_bright, bg or Colors.bg_main) end
...
writeText(tradeMarketX, 2, "ДОБРО ПОЖАЛОВАТЬ, ВЫ НАХОДИТЕСЬ В МАГАЗИНЕ НА TRADE MARKET", Colors.cyan, Colors.bg_header)

...
local function getDiscountInfo(spentCoin, spentEma)
...
local function currentDiscountPercent()
...
local function refreshSessionDiscount()
...
local function openDiscountModal()
...
segLine(Y, { { "1 Уровень = Купить товара суммарно на 1000 ", Colors.text_main }, { "COINS", Colors.accent_cyan }, { " или ", Colors.text_main }, { "EM", Colors.orange }, { " = 2% скидка", Colors.text_main } }); Y = Y + 1
segLine(Y, { { "2 Уровень = Купить товара суммарно на 3000 ", Colors.text_main }, { "COINS", Colors.accent_cyan }, { " или ", Colors.text_main }, { "EM", Colors.orange }, { " = 4% скидка", Colors.text_main } }); Y = Y + 1
segLine(Y, { { "3 Уровень = Купить товара суммарно на 10000 ", Colors.text_main }, { "COINS", Colors.accent_cyan }, { " или ", Colors.text_main }, { "EM", Colors.orange }, { " = 6% скидка", Colors.text_main } }); Y = Y + 1
segLine(Y, { { "4 Уровень = Купить товара суммарно на 25000 ", Colors.text_main }, { "COINS", Colors.accent_cyan }, { " или ", Colors.text_main }, { "EM", Colors.orange }, { " = 8% скидка", Colors.text_main } }); Y = Y + 1
segLine(Y, { { "5 Уровень = Купить товара суммарно на 50000 ", Colors.text_main }, { "COINS", Colors.accent_cyan }, { " или ", Colors.text_main }, { "EM", Colors.orange }, { " = 10% скидка", Colors.text_main } }); Y = Y + 2
...
segLine(Y, { { "Всего вы купили товаров в магазине на ", Colors.text_main }, { scStr .. " COINS", Colors.accent_cyan }, { " и ", Colors.text_main }, { seStr .. " EM.", Colors.orange } })
else
local nextTh = DISCOUNT_TIERS[level + 1].threshold
local remain = math.max(0, nextTh - total)
segLine(Y, { { "Всего вы купили товаров в магазине на ", Colors.text_main }, { scStr .. " COINS", Colors.accent_cyan }, { " и ", Colors.text_main }, { seStr .. " EM,", Colors.orange } })
Y = Y + 1
segLine(Y, { { "до следующего уровня скидки осталось потратить", Colors.text_main } })
Y = Y + 1
segLine(Y, { { "суммарно " .. formatPrice(remain) .. " COINS или EM.", Colors.accent_cyan } })
end

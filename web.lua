    ...
    if kind == "help" then
        ...
        if State.helpPage == 1 then
            lines = {
                ...
                { text = "[ Покупки ]", color = Colors.success_green, "- обычный каталог товаров магазина.", color = Colors.text_main, center = true },
                { text = "Выбирайте товар из списка мышкой, в правом блоке вы сможете увидеть подробности о товаре.", color = Colors.text_main, center = true },
                ...
                { text = "Фильтр каталога по категориям различных модов", color = Colors.text_main, center = true },
                { text = "", color = Colors.text_main },
                { text = "--- ЧТО ТАКОЕ COINA & EMA ---", color = Colors.accent_cyan, center = true },
                { text = "COINA - внутренняя валюта магазина (эквивалент 1 железного слитка)", color = Colors.accent_cyan, center = true },
                { text = "EMA - эквивалент игровой валюты сервера, ЭМов.", color = Colors.tomato, center = true },
                { text = "", color = Colors.text_main },
                ...
                { text = "[ МАКС ] вводит максимальное количество предметов, с учётом доступного баланса и свободного места в инвентаре", color = Colors.text_main, center = true },
                { text = "", color = Colors.text_main },

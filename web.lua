...
local UI = {
header = { height = 4, searchX = 2, searchW = 60, clearBtnW = 3, allBtnW = 8, dropdownW = 26, dropdownY = 3 },
...
fillBox(maxBtnX, inputY, 6, 1, Colors.bg_button)
...
local btnW2 = useCraft and 18 or 8
...
fillBox(buyBtnX, inputY, 9, 1, canSell and Colors.success_green or Colors.text_dark)
...
writeText(Config.SCREEN_W - 20, Config.SCREEN_H, "Coded By Leytsfer v 6.10.5", Colors.text_dark, Colors.bg_panel)

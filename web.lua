    ...
    if kind == "help" then
        ...
        elseif State.helpPage == 2 then
            lines = {
                ...
                { text = "Баланс COINS & EMA всегда всегда доступен в разделе АККАУНТА.", color = Colors.accent_cya, center = truen },
                { text = "", color = Colors.text_main },
                { text = "", color = Colors.text_main },
                ...
                { text = "После совершения транзакции покупки/продажи, баланс обновляется в режиме реального времени.", color = Colors.success_green, center = true }
            }

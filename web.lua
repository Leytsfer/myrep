...
local FOOTER_OWNER = "Coded by ZoziDo, updated by Leytsfer"
...
local ore_list = {
    ...
    { take = { label = "Свинцовая руда", name = "IC2:blockOreLead", amount = 3 }, give = { label = "Свинцовый слиток", name = "IC2:itemIngot", damage = 5.0, amount = 7 } },
...
local function drawTableFrame()
    ...
    gpu.set(
        UI.tableX,
        UI.headerY,
        makeRow(" РУДА", " ПРОГРЕСС", " В МЭ", " КУРС", " РЕЗУЛЬТАТ")
    )

...
table.insert(State.logMessages, { segs = segs, text = plain })
markDirty("right")
end
...
local maxLines = math.floor((logH - 3) / 2)
...
writeText(Config.SCREEN_W - 20, Config.SCREEN_H, "v 6.9.10", Colors.text_dark, Colors.bg_panel)
local reportBtnW = 18
...
drawCenteredText(30, "Trade Shop by Leytsfer — v 6.9.10", Colors.text_main, Colors.bg_main)
local logStartY = 32
...
-- мгновенный вывод строки лога крафта (без очереди)
...
-- во время крафта игрок только ждёт: игнорируем все клики
...
-- во время крафта игрок только ждёт: игнорируем все клавиши

    ...
    if kind == "help" then
        ...
        elseif State.helpPage == 5 then
            lines = {
                ...
                { text = "", color = Colors.text_main },
                { text = "Магазин всё ещё находится в открытом [BETA].", color = Colors.tomato },
                { text = "Если во время работы с магазином вы столкнётесь с незапланированным багом или ошибкой, вы можете оставить на ней репорт.", color = Colors.text_main, center = true },

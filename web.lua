-- ============================================================
-- TRADE MARKET CLIENT v6.9.19 (POST-SYNC CONFIRM WINDOW)
-- ============================================================
...
writeText(Config.SCREEN_W - 20, Config.SCREEN_H, "v 6.9.19", Colors.text_dark, Colors.bg_panel)
local reportBtnW = 18
...
drawCenteredText(30, "Trade Shop by Leytsfer — v 6.9.19", Colors.text_main, Colors.bg_main)
local logStartY = 32
...
-- финальная аппаратная проверка перед открытием
...
-- ФАЗА 1: выдержка 2 сек, НЕ идём на сервер
...
-- ФАЗА 3: окно подтверждения после синхронизации (ловит запоздалый player_off и аппаратное отсутствие)

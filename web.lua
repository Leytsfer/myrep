...
local UI = {
header = { height = 4, searchX = 2, searchW = 60, clearBtnW = 3, allBtnW = 10, dropdownW = 26, dropdownY = 3 },
...
local btnW2 = useCraft and 20 or 10
...
writeText(Config.SCREEN_W - 30, Config.SCREEN_H, "Coded By Leytsfer v 6.10.5", Colors.text_dark, Colors.bg_panel)

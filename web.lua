    ...
    if kind == "help" then
        ...
        elseif State.helpPage == 2 then
            lines = {
                ...
                { text = "Баланс COINS & EMA всегда всегда доступен в разделе АККАУНТА.", color = Colors.accent_cya, center = true },
                { text = "", color = Colors.text_main },
                { text = "", color = Colors.text_main },
        ...
        elseif State.helpPage == 3 then
            lines = {
                ...
                { text = "Нажмите [ ПРОДАТЬ ] и в разделе ЛОГИРОВАНИЯ вы увидите количество проданных предметов за сколько они были проданы.", color = Colors.text_main, center = true },
                { text = "В результате успешной продажи магазин изымает продаваемые предметы.", color = Colors.text_main, center = true },
                { text = "Перед подтверждением всегда проверяйте название, количество и итоговую сумму.", color = Colors.text_gray, center = true }
            }

...
{ text = "", color = Colors.text_main },
{ text = "В правом информационном блоке ПОКУПАЕМЫЙ ПРЕДМЕТ должен быть статус АВТОКРАФТ: ДОСТУПЕН.", color = Colors.text_main, center = true },
...
{ text = "", color = Colors.text_main },
{ text = "Магазин всё ещё находится в стадии открытого [BETA] тестирования!.", color = Colors.tomato, center = true },

-- ============================================================
-- TRADE MARKET CLIENT v6.9.18 (HOLD-THEN-SYNC PRESENCE)
-- ============================================================
...
-- Аппаратный датчик присутствия через размер инвентаря PIM
...
writeText(Config.SCREEN_W - 20, Config.SCREEN_H, "v 6.9.18", Colors.text_dark, Colors.bg_panel)
local reportBtnW = 18
...
drawCenteredText(30, "Trade Shop by Leytsfer — v 6.9.18", Colors.text_main, Colors.bg_main)
local logStartY = 32
...
-- ФАЗА 1: просим постоять 2 сек, НЕ идём на сервер
addWelcomeLog("⏳ Постойте 2 секунды...", Colors.warning)
...
-- ФАЗА 2: синхронизация с сервером
...
-- Аппаратный watchdog присутствия через getInventorySize

-- ============================================================
-- TRADE MARKET CLIENT v6.9.16 (RENDER-FIRST + DEFERRED ME)
-- ============================================================
...
writeText(Config.SCREEN_W - 20, Config.SCREEN_H, "v 6.9.16", Colors.text_dark, Colors.bg_panel)
local reportBtnW = 18
...
drawCenteredText(30, "Trade Shop by Leytsfer — v 6.9.16", Colors.text_main, Colors.bg_main)
local logStartY = 32

...
if not needBuy and not needSell and not needUsers then addWelcomeLog("✅ Версии актуальны, готовим запуск", Colors.success_green); return syncEnd("ok", source) end

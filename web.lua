...
local function drawModal()
    ...
    if kind == "help" then
        ...
        if State.helpPage == 1 then
            lines = {
                { text = "ТОРГОВАЯ СЕССИЯ", color = Colors.accent_cyan, center = true },
                { text = "", color = Colors.text_main },
                { text = "1. Встаньте на PIM, дождитесь авторизации, загрузки каталогов", color = Colors.text_main, center = true },
                { text = "   Пока вы стоите на PIM, магазин закрепляет текущую сессию именно за вами.", color = Colors.text_gray, center = true },
                { text = "", color = Colors.text_main },
                ...
                { text = "• Выбирайте товар мышкой или стрелками ↑ / ↓.", color = Colors.text_main, center = true },
                { text = "• Для поиска просто начните печатать название - отдельный клик по поиску не обязателен.", color = Colors.text_main, center = true },
                { text = "• Фильтр каталога: ВСЕ ТОВАРЫ / В НАЛИЧИИ / НЕ В НАЛИЧИИ.", color = Colors.text_main, center = true },
                { text = "", color = Colors.text_main },
                { text = "— ВАЛЮТА МАГАЗИНА —", color = Colors.accent_cyan, center = true },
                { text = "В МЭ   - сколько выбранного товара сейчас находится в основной МЭ-системе.", color = Colors.success_green, center = true },
                { text = "COINA  - цена за 1 предмет в балансе COINA.", color = Colors.accent_cyan, center = true },
                { text = "EMA    - цена за 1 предмет в балансе EMA.", color = Colors.tomato, center = true },
                { text = "", color = Colors.text_main },
                { text = "— КОЛИЧЕСТВО —", color = Colors.accent_cyan, center = true },
                { text = "1. Выберите товар и нажмите на поле КОЛИЧЕСТВО.", color = Colors.text_main, center = true },
                { text = "2. Введите число. Магазин сразу пересчитает итоговую стоимость.", color = Colors.text_main, center = true },
                { text = "3. [ Стереть ] очищает введённое количество.", color = Colors.text_main, center = true },
                { text = "", color = Colors.text_main },
